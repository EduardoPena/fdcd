...
public class NTreeSearch implements ISubsetBackend, ITreeSearch {
	...
	public HashMap<Integer, NTreeSearch> getSubtrees() {
		return subtrees;
	}
	
	public  NTreeSearch getSubtree(int i) {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ch.javasoft.bitset.search.ITreeSearch#add(ch.javasoft.bitset.IBitSet)
	 */
	@Override
	 ...
	 * (non-Javadoc)
	 * 
	 * @see ch.javasoft.bitset.search.ITreeSearch#remove(ch.javasoft.bitset.IBitSet)
	 */
	@Override
