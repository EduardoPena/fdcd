...
public class INCS implements DCEnumeration {
	...
	public INCS(PredicateSpace predicateSpace, EvidenceSet evidenceSet) {
		this(predicateSpace, evidenceSet, true, true);
	}

	public INCS(PredicateSpace predicateSpace, EvidenceSet evidenceSet, boolean parallel) {
		this(predicateSpace, evidenceSet, true, parallel);
	}

	public INCS(PredicateSpace predicateSpace, EvidenceSet evidenceSet, boolean checkMinimals, boolean parallel) {
	...
	public Set<BitSet> searchDCs() {
		...
		stream.forEach(i -> {
			...
			INCSExecutor search = new INCSExecutor(currPreds, pSpace,
